...
class All_cnn_c(object):
    ...
    def train(self,
              ...
              e3=300,
              drop_rate=0.1,
              test_history_filepath='test_history_allcnn_c.csv'):
        self.initial_lr = initial_lr
    ...
    def save_model_weights(self, filepath='model_allconv_c_weights.h5'):
...
if __name__ == '__main__':
    with open('config_allconv_c.yaml', 'r') as f:
        config = yaml.load(f)
    ...
    model = All_cnn_c(activation=activation, weight_decay=weight_decay)
