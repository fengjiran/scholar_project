...
class model_a(object):
    ...
    def train(self,
              ...
              train_history_filepath='train_history_a.csv',
              test_history_filepath='test_history_a.csv'
              ):
        self.initial_lr = initial_lr
        ...
        if lr_scheduler:
            ...
            # lrate = LearningRateScheduler(self.step_decay_lr)
    ...
    #     lr = self.initial_lr * math.pow(self.drop_rate, math.floor((1 + epoch) / self.epochs_drop))
    ...
    def save_model_weights(self, filepath='model_a_weights.h5'):
...
if __name__ == '__main__':
    ...
    with open('config_a.yaml', 'r') as f:
        config = yaml.load(f)
    ...
    model = model_a(activation=activation, weight_decay=weight_decay)

    start_time = time.clock()

    # with open(test_history_filepath, 'a+') as f:
    #     mywrite = csv.writer(f)
    #     mywrite.writerow(['test_loss', 'test_acc'])
