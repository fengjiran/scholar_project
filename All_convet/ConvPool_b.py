...
class ConvPool_cnn_b(object):
    ...
    def save_model_weights(self, filepath='model_convpool_b_weights.h5'):
...
if __name__ == '__main__':
    with open('config_convpool_b.yaml', 'r') as f:
        config = yaml.load(f)
    ...
    model = ConvPool_cnn_b(activation=activation, weight_decay=weight_decay)
