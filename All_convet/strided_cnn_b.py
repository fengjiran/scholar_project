...
class strided_cnn_b(object):
    ...
    def train(self,
              ...
              train_history_filepath='train_history_b.csv',
              test_history_filepath='test_history_b.csv'
              ):
        self.initial_lr = initial_lr
    ...
    def save_model_weights(self, filepath='model_strided_b_weights.h5'):
...
if __name__ == '__main__':
    ...
    with open('config_strided_b.yaml', 'r') as f:
        config = yaml.load(f)
    ...
    model = strided_cnn_b(activation=activation, weight_decay=weight_decay)
