...
class ConvPool_cnn_a(object):
    ...
    def train(self,
              ...
              train_history_filepath='train_history_convpool_a.csv',
              test_history_filepath='test_history_convpool_a.csv'
              ):
        self.initial_lr = initial_lr
    ...
    def save_model_weights(self, filepath='model_convpool_a_weights.h5'):
...
if __name__ == '__main__':
    ...
    with open('config_convpool_a.yaml', 'r') as f:
        config = yaml.load(f)
    ...
    model = ConvPool_cnn_a(activation=activation, weight_decay=weight_decay)
