...
class strided_cnn_a(object):
    ...
    def train(self,
              ...
              e3=300,
              drop_rate=0.1,
              train_history_filepath='train_history_strided_a.csv',
              test_history_filepath='test_history_strided_a.csv'
              ):
        self.initial_lr = initial_lr
        # self.drop_rate = drop_rate
    ...
    def save_model_weights(self, filepath='model_strided_a_weights.h5'):
...
if __name__ == '__main__':
    # train()
    with open('config_strided_a.yaml', 'r') as f:
        config = yaml.load(f)
    ...
    model = strided_cnn_a(activation=activation, weight_decay=weight_decay)
